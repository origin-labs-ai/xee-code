...
Every switch, its accepted values, and the protocols that take it are listed under `PiAiCompatProfile` in the [generated `xhe-llm-pi-ai` configuration reference](../../config-catalog.md#deepseek-aixhe-llm-pi-ai) — which is derived from the source, so it cannot fall behind what the adapter accepts.
...
The generated [plugin configuration catalog](../../config-catalog.md) lists every supported field and default for every plugin; [`xhe-llm-pi-ai`](../../config-catalog.md#deepseek-aixhe-llm-pi-ai) is the provider section this page configures. The [`xhe-llm-pi-ai`](../../../packages/llm/llm-pi-ai/README.md) and [`xhe-llm-deepseek`](../../../packages/llm/llm-deepseek/README.md) references own direct `settings.yaml` configuration, catalog resolution, reasoning controls, credentials, and adapter errors.
