...
| `ctx.clientModules` | `core` | `modules` | - | `hmr` | - | Composes the __CF_BOOT__ entry graph from an incremental dsh.client scan, serves plugin bundles, and notifies rebuilt/graph-changed subscribers. |
