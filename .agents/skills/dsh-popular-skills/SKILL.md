name: dsh-popular-skills
description: Collection of 20+ popular Claude Code-style skills and slash commands for DSH (DeepSeek Harness). Includes code review, testing, git workflow, debugging, Gauntlet-Loop pattern, and more. Use when user wants powerful AI coding agent capabilities.
---

# DSH Popular Skills Collection

**Supercharge your DSH experience with 20+ battle-tested skills inspired by Claude Code, Cursor, and Gauntlet-Loop patterns.**
...
These skills work with DSH's native:
...
Every skill follows DSH conventions:
