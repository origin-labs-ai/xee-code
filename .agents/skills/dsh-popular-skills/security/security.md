name: dsh-security
description: Use when user wants to scan for vulnerabilities, perform security audits, or check code for security issues. Covers OWASP Top 10, dependency vulnerabilities, and DSH-specific security patterns.
---
...
### 2. DSH-Specific Security Patterns
