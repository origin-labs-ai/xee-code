...
6. If removing prose changes a promised behavior rather than its explanation, use a proposed Agent Note first (follow [cf-find-simplifications](../cf-find-simplifications/SKILL.md)).
