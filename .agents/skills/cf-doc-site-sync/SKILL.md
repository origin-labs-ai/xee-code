...
- Read [docs/AGENTS.md](../../../docs/AGENTS.md) and use [cf-doc-standards](../cf-doc-standards/SKILL.md) when deciding where content belongs or changing product documentation prose.
...
Use [cf-pre-push-checks](../cf-pre-push-checks/SKILL.md) before pushing. Report the canonical files changed, manifest entries added or removed, public routes affected, and the exact checks run.
