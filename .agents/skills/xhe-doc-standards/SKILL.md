...
6. If removing prose changes a promised behavior rather than its explanation, use a proposed Agent Note first (follow [xhe-find-simplifications](../xhe-find-simplifications/SKILL.md)).
