...
- Human slash-command discovery and rendering are owned by the separate [`xhe-command-goal`](../../../../packages/goal/command-goal/README.md) plugin.
