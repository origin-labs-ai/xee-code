...
- **A thin workflow skill, contracts in docs.** [.agents/skills/cf-doc-standards](../../../skills/cf-doc-standards/SKILL.md) carries the placement/audit/red-gate workflow and defers to the standard as its source of truth, the same split as [cf-translate-docs](../../../skills/cf-translate-docs/SKILL.md) over the i18n contract.
