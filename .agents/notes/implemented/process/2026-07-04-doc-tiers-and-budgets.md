...
- **A thin workflow skill, contracts in docs.** [.agents/skills/xhe-doc-standards](../../../skills/xhe-doc-standards/SKILL.md) carries the placement/audit/red-gate workflow and defers to the standard as its source of truth, the same split as [xhe-translate-docs](../../../skills/xhe-translate-docs/SKILL.md) over the i18n contract.
