...
When a shipped note is unlikely to guide future work, archive its complete triplet through [`cf-archive-agent-notes`](../../skills/cf-archive-agent-notes/SKILL.md) instead of continuing to maintain it.
