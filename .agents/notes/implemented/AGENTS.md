...
When a shipped note is unlikely to guide future work, archive its complete triplet through [`xhe-archive-agent-notes`](../../skills/xhe-archive-agent-notes/SKILL.md) instead of continuing to maintain it.
