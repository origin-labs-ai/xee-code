...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  cfHomePath: 'not a service: boot-provided root accessor function (typeof cfHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
