 ...
 * `@origin-ai/xhe-cmdline`). Launcher flags therefore come first: the first
...
export function parseDshArgs(argv: readonly string[], version: string): DshInvocation {
  ...
  program
    ...
    .option('--profile <name>', 'the profile under $XHE_HOME/profiles to boot')
