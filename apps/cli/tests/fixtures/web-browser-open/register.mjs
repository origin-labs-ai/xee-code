...
const exitMarker = join(process.cwd(), `.xhe-browser-open-${process.pid}`)
...
if (process.env.XHE_BROWSER_OPEN_TEST_EXIT_ON_READY === '1') {
...
if (process.env.XHE_BROWSER_OPEN_TEST_EXIT_ON_FAILURE === '1') {
