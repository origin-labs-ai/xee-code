...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@origin-ai/xhe-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@origin-ai/xhe-tool-workflow'
```
