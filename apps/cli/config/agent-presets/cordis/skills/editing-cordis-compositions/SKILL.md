...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@origin-ai/cf-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@origin-ai/cf-tool-workflow'
```
