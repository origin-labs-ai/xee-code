...
import type {} from '@origin-ai/xhe-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@origin-ai/xhe-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@origin-ai/xhe-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@origin-ai/xhe-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@origin-ai/xhe-skill-filesystem"}\n',
