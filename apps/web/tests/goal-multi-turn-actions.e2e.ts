...
import type {} from '@origin-ai/cf-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@origin-ai/cf-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@origin-ai/cf-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@origin-ai/cf-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@origin-ai/cf-skill-filesystem"}\n',
