...
import { createMessage, createUserMessage } from '@origin-ai/xhe-llm'
import {
...
const LONG_TOKEN = 'workspace/xhe/packages/client/ui-primitives/src/markdown/render.tsx/'.repeat(3)
const CJK_SENTENCE = '这个单元格包含一段较长的说明，用来验证长内容在窄列宽下按最小可读宽度换行而不是把列压缩到无法阅读。'
