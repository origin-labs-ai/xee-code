...
import * as GoalSessionInvariant from '@origin-ai/cf-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@origin-ai/cf-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@origin-ai/cf-goal-round-driver',
    }))
  })
