/**
 * Package-owned invariant companion for `@origin-ai/xhe-command-goal`.
 * @module @origin-ai/xhe-command-goal/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-command-goal'
