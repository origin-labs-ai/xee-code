...
The six generated schemas are listed in the [`xhe-tool-terminal` catalog section](../../../docs/tool-catalog.md#deepseek-aixhe-tool-terminal). Their fixed schema tokens are present whenever this plugin is active; agent-scoped tool filtering may hide them.
