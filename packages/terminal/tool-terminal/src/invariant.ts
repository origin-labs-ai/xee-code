/**
 * Package-owned invariant companion for `@origin-ai/cf-tool-terminal`.
 * @module @origin-ai/cf-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-tool-terminal'
