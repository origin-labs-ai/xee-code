 ...
 * model-facing render consumes ({@link module:@origin-ai/xhe-tool-fs-search/search-core}
 ...
 *
 * @module @origin-ai/xhe-tool-fs-search/presentation
 */
 ...
 * ({@link module:@origin-ai/xhe-tool-fs-search/grep} `formatGrepMatches`), so
