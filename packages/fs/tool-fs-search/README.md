...
The glob description states the configured over-cap ordering. The generated [`glob` and `grep` schemas](../../../docs/tool-catalog.md#deepseek-aixhe-tool-fs-search) use `sampleOverCapGlobResults: true`; the tools are registered unconditionally.
