...
import type { Agent, AgentOptions, AgentSetup } from '@origin-ai/xhe-agent'
...
import type {} from '@origin-ai/xhe-typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a xhe-session-persistence backend)')
  }
