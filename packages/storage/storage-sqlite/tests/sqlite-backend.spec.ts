...
import Storage, { storageBackendServiceKey } from '@origin-ai/xhe-storage'
import type { KvUnitDescriptor } from '@origin-ai/xhe-storage'
...
async function freshDbPath(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'xhe-storage-sqlite-'))
  dirs.push(dir)
