/**
 * Package-owned invariant companion for `@origin-ai/xhe-tool-subagent`.
 * @module @origin-ai/xhe-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tool-subagent'
