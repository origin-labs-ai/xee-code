/**
 * Package-owned invariant companion for `@origin-ai/cf-tool-subagent`.
 * @module @origin-ai/cf-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-tool-subagent'
