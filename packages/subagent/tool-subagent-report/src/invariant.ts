/**
 * Package-owned invariant companion for `@origin-ai/xhe-tool-subagent-report`.
 * @module @origin-ai/xhe-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tool-subagent-report'
