/**
 * Package-owned invariant companion for `@origin-ai/cf-tool-subagent-report`.
 * @module @origin-ai/cf-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-tool-subagent-report'
