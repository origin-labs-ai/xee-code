/**
 * Package-owned invariant companion for `@origin-ai/cf-subagent-sdk`.
 * @module @origin-ai/cf-subagent-sdk/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-subagent-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-cf-sdk-invariant'
