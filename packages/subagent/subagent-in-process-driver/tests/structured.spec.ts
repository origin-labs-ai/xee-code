...
import { createUserMessage, CallId, type ContentBlock, type GenerateOptions } from '@origin-ai/xhe-llm'
...
import type { Config as ToolConfig, ObjectJsonSchema } from '@origin-ai/xhe-tools'
import { defineContentToolFixture, RUN_CODE_NAME } from '@origin-ai/xhe-tools'
