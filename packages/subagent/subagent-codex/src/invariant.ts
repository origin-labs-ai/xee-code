/**
 * Package-owned invariant companion for `@origin-ai/cf-subagent-codex`.
 * @module @origin-ai/cf-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-subagent-codex'
