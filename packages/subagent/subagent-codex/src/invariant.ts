/**
 * Package-owned invariant companion for `@origin-ai/xhe-subagent-codex`.
 * @module @origin-ai/xhe-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-subagent-codex'
