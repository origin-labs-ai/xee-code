...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@origin-ai/xhe-sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@origin-ai/xhe-user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'xhe-continuation-inherit-'))
  roots.push(root)
