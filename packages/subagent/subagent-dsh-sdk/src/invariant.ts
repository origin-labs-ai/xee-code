/**
 * Package-owned invariant companion for `@origin-ai/cf-subagent-xhe-sdk`.
 * @module @origin-ai/cf-subagent-xhe-sdk/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-subagent-xhe-sdk'
