/**
 * Package-owned invariant companion for `@origin-ai/xhe-tool-call-timeout-policy`.
 * @module @origin-ai/xhe-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tool-call-timeout-policy'
