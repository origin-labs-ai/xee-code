/**
 * Package-owned invariant companion for `@origin-ai/cf-tool-call-timeout-policy`.
 * @module @origin-ai/cf-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-tool-call-timeout-policy'
