/**
 * Package-owned invariant companion for `@origin-ai/cf-repeat-tool-reminder`.
 * @module @origin-ai/cf-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-repeat-tool-reminder'
