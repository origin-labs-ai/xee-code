/**
 * Package-owned invariant companion for `@origin-ai/xhe-repeat-tool-reminder`.
 * @module @origin-ai/xhe-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-repeat-tool-reminder'
