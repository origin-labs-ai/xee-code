/**
 * Package-owned invariant companion for `@origin-ai/cf-workflow-worker-thread`.
 * @module @origin-ai/cf-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-workflow-worker-thread'
