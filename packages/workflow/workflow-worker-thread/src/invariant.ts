/**
 * Package-owned invariant companion for `@origin-ai/xhe-workflow-worker-thread`.
 * @module @origin-ai/xhe-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-workflow-worker-thread'
