 ...
 * @module @origin-ai/cf-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@origin-ai/cf-llm'
import { SessionId } from '@origin-ai/cf-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@origin-ai/cf-tools'
import type { ObjectJsonSchema } from '@origin-ai/cf-tools'
import { isFatalWorkflowError, WorkflowError } from '@origin-ai/cf-workflow'
import type {
