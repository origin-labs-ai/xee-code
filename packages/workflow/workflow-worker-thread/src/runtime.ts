 ...
 * @module @origin-ai/xhe-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@origin-ai/xhe-llm'
import { SessionId } from '@origin-ai/xhe-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@origin-ai/xhe-tools'
import type { ObjectJsonSchema } from '@origin-ai/xhe-tools'
import { isFatalWorkflowError, WorkflowError } from '@origin-ai/xhe-workflow'
import type {
