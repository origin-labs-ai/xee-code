...
import type { SubagentCapabilities, SubagentProvider, SubagentRun, SubagentStartRequest } from '@origin-ai/xhe-subagent'
...
import type { WorkflowResult, WorkflowRun, WorkflowStartRequest } from '@origin-ai/xhe-workflow'
