/**
 * Package-owned invariant companion for `@origin-ai/xhe-agent-tool-presentation`.
 * @module @origin-ai/xhe-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-agent-tool-presentation'
