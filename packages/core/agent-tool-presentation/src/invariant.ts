/**
 * Package-owned invariant companion for `@origin-ai/cf-agent-tool-presentation`.
 * @module @origin-ai/cf-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-agent-tool-presentation'
