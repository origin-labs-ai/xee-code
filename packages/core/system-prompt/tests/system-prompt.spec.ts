...
import SystemPrompt, { AssembleContext, PromptAssembly, renderContextSnapshot, renderPrompt } from '@origin-ai/xhe-system-prompt'
...
const IDENTITY = 'You are an AI agent powered by Xee Harness Enhanced.'
