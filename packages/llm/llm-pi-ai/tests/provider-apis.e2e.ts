...
import { AttachmentId, AttachmentStore, ImageVariantId } from '@origin-ai/xhe-attachment'
import type {
...
import LlmRuntime, { createUserMessage, CallId } from '@origin-ai/xhe-llm'
...
const openAIBaseURL = process.env.XHE_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.XHE_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.XHE_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.XHE_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',
