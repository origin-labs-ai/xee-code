...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@origin-ai/xhe-authorization'
import { isCredentialKeySegment } from '@origin-ai/xhe-credentials'
