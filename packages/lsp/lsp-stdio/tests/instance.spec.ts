...
import { LspInstance, readHostSource } from '@origin-ai/xhe-lsp-stdio'
import { encodeMessage } from '@origin-ai/xhe-lsp-stdio'
import type { ConnectionWriter } from '@origin-ai/xhe-lsp-stdio/src/connection.ts'
import type { InstanceSpec } from '@origin-ai/xhe-lsp-stdio/src/instance.ts'
import type { LspProviderQuery, LspQueryResult } from '@origin-ai/xhe-lsp'
