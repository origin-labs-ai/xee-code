/**
 * Package-owned invariant companion for `@origin-ai/xhe-tool-session-query`.
 * @module @origin-ai/xhe-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tool-session-query'
