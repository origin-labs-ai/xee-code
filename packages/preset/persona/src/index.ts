 ...
 *
 * `xhe-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `xhe-subagent` installs; mounted globally
...
import { PERSONA_ORDER, PERSONA_SECTION } from '@origin-ai/xhe-system-prompt'
