/**
 * Package-owned invariant companion for `@origin-ai/cf-agent-presets`.
 * @module @origin-ai/cf-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@origin-ai/cf-agent-presets'

const PACKAGE_NAME = '@origin-ai/cf-agent-presets'
