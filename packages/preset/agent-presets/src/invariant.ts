/**
 * Package-owned invariant companion for `@origin-ai/xhe-agent-presets`.
 * @module @origin-ai/xhe-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@origin-ai/xhe-agent-presets'

const PACKAGE_NAME = '@origin-ai/xhe-agent-presets'
