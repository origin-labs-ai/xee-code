...
import AgentRegistry, { assembleContextFor } from '@origin-ai/xhe-agent'
import AgentLoop from '@origin-ai/xhe-agent-loop'
import InvariantRegistry from '@origin-ai/xhe-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@origin-ai/xhe-agent-presets'
import * as AgentPresetsInvariant from '@origin-ai/xhe-agent-presets/invariant'
