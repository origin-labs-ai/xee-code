/**
 * Package-owned invariant companion for `@origin-ai/xhe-host-webserver`.
 * @module @origin-ai/xhe-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-host-webserver'
