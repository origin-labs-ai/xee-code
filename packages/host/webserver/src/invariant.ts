/**
 * Package-owned invariant companion for `@origin-ai/cf-host-webserver`.
 * @module @origin-ai/cf-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-host-webserver'
