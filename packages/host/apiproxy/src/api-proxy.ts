...
export function createApiProxy(ctx: Context, defaults: ApiProxyDefaults): ApiProxy {
  ...
  // attachment Service Definition: xhe-llm depends on xhe-attachment, so the
  ...
  return {
    ...
    agentPresets: {
      ...
      // Authoring is privileged (see PRIVILEGED_METHODS in xhe-client-connection):
    ...
    skills: {
      ...
      async list(request) {
        ...
        // composition mounts xhe-skill, not an empty catalog. `ctx.get` also
