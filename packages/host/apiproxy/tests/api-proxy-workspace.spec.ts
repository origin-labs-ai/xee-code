...
import type { Agent, AgentFactory } from '@origin-ai/cf-agent'
...
import type { DirectoryPickerCapability } from '@origin-ai/cf-host-directory-picker'
import WorkspaceRegistry from '@origin-ai/cf-workspace'
import type { HostFrame, WorkspaceId } from '@origin-ai/cf-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@origin-ai/cf-host-apiproxy/api/rpc'
