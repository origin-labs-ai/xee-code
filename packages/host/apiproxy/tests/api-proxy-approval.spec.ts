...
import type { ApprovalRequestId } from '@origin-ai/xhe-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@origin-ai/xhe-host-apiproxy/api'
import type { RpcId } from '@origin-ai/xhe-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@origin-ai/xhe-host-apiproxy/api/rpc'
