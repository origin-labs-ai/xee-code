/**
 * Package-owned invariant companion for `@origin-ai/xhe-credentials-local`.
 * @module @origin-ai/xhe-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-credentials-local'
