/**
 * Package-owned invariant companion for `@origin-ai/cf-credentials-local`.
 * @module @origin-ai/cf-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-credentials-local'
