...
const KEY = credentialRef('XHE_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'xhe-credentials-watch-'))
