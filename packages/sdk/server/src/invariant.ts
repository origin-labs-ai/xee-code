/**
 * Package-owned invariant companion for `@origin-ai/xhe-sdk-jsonrpc-server`.
 * @module @origin-ai/xhe-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-sdk-jsonrpc-server'
