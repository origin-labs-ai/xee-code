/**
 * Package-owned invariant companion for `@origin-ai/cf-sdk-jsonrpc-server`.
 * @module @origin-ai/cf-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-sdk-jsonrpc-server'
