/**
 * Package-owned invariant companion for `@origin-ai/xhe-sdk-protocol`.
 * @module @origin-ai/xhe-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-sdk-protocol'
