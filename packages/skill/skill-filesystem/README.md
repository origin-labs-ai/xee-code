...
| `dshHome` | `$XHE_HOME` or `~/.dsh` | Xee Harness Enhanced config root resolved by [`@origin-ai/xhe-home-paths`](../../util/home-paths/README.md); scans `skills` under this directory. |
