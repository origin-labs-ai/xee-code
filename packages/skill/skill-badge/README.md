...
The provider exposes its packaged `assets/` directory as the skill resource base. `cf-badge.png` is the 726×120 source asset, and consumers render it at 121×20.
