/**
 * Package-owned invariant companion for `@origin-ai/xhe-tmux-context`.
 * @module @origin-ai/xhe-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tmux-context'
