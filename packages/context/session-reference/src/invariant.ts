/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-reference`.
 * @module @origin-ai/xhe-session-reference/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-reference'
