/**
 * Package-owned invariant companion for `@origin-ai/cf-session-reference`.
 * @module @origin-ai/cf-session-reference/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-reference'
