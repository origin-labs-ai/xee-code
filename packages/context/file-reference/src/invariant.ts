/**
 * Package-owned invariant companion for `@origin-ai/cf-file-reference`.
 * @module @origin-ai/cf-file-reference/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-file-reference'
