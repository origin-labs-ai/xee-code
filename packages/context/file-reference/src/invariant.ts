/**
 * Package-owned invariant companion for `@origin-ai/xhe-file-reference`.
 * @module @origin-ai/xhe-file-reference/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-file-reference'
