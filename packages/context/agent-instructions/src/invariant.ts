/**
 * Package-owned invariant companion for `@origin-ai/xhe-agent-instructions`.
 * @module @origin-ai/xhe-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-agent-instructions'
