/**
 * Package-owned invariant companion for `@origin-ai/cf-agent-instructions`.
 * @module @origin-ai/cf-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-agent-instructions'
