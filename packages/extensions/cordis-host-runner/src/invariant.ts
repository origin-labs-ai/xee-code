/**
 * Package-owned invariant companion for `@deepseek-ai/cordis-host-runner`.
 * @module @deepseek-ai/cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/cordis-host-runner'
