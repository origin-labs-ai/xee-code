/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-cordis`.
 * @module @origin-ai/cf-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-cordis'
