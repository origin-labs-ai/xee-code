/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-cordis`.
 * @module @origin-ai/xhe-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-cordis'
