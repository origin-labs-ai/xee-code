/**
 * Package-owned invariant companion for `@deepseek-ai/cordis-client-runner`.
 * @module @deepseek-ai/cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/cordis-client-runner'
