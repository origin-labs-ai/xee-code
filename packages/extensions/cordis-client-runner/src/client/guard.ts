...
import type { DynamicCordisPackage } from '@origin-ai/xhe-api-remotes/client'
import type { SlotRegistry } from '@origin-ai/xhe-client-runtime/client'
import type { ThemeRuntime } from '@origin-ai/xhe-client-ui-theme/client'
