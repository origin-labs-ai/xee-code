...
import type { DynamicCordisPackage } from '@origin-ai/cf-api-remotes/client'
import type { SlotRegistry } from '@origin-ai/cf-client-runtime/client'
import type { ThemeRuntime } from '@origin-ai/cf-client-ui-theme/client'
