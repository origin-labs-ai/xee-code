...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@origin-ai/xhe-agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@origin-ai/xhe-acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@origin-ai/xhe-sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
