/**
 * Package-owned invariant companion for `@origin-ai/xhe-agent-spine-demo`.
 * @module @origin-ai/xhe-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-agent-spine-demo'
