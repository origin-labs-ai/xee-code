/**
 * Package-owned invariant companion for `@origin-ai/cf-agent-spine-demo`.
 * @module @origin-ai/cf-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-agent-spine-demo'
