/**
 * Package-owned invariant companion for `@origin-ai/xhe-loader-smoke`.
 * @module @origin-ai/xhe-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-loader-smoke'
