/**
 * Package-owned invariant companion for `@origin-ai/cf-agent-loop-testkit`.
 * @module @origin-ai/cf-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-agent-loop-testkit'
