/**
 * Package-owned invariant companion for `@origin-ai/xhe-agent-loop-testkit`.
 * @module @origin-ai/xhe-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-agent-loop-testkit'
