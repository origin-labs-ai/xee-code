/**
 * Package-owned invariant companion for `@origin-ai/cf-user-questions`.
 * @module @origin-ai/cf-user-questions/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-user-questions'
