/**
 * Package-owned invariant companion for `@origin-ai/xhe-user-questions`.
 * @module @origin-ai/xhe-user-questions/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-user-questions'
