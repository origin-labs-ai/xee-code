/**
 * Package-owned invariant companion for `@origin-ai/cf-tool-ask-user`.
 * @module @origin-ai/cf-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-tool-ask-user'
