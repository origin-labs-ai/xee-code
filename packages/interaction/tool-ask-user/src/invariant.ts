/**
 * Package-owned invariant companion for `@origin-ai/xhe-tool-ask-user`.
 * @module @origin-ai/xhe-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tool-ask-user'
