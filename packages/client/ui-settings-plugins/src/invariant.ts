/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-settings-plugins`.
 * @module @origin-ai/cf-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-settings-plugins'
