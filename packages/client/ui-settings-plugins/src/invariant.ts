/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-settings-plugins`.
 * @module @origin-ai/xhe-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-settings-plugins'
