 ...
 * `__CF_BOOT__` wire types, the boot-manifest parser, and the boundaries around
...
/** The composed client entry graph the host injects as `window.__CF_BOOT__`. */
...
export function parseBootManifest(wire: unknown): BootManifest {
  if (typeof wire !== 'object' || wire === null) {
    throw new Error('client-modules: window.__CF_BOOT__ is missing or not an object')
  }
