/**
 * Package-owned invariant companion for `@origin-ai/cf-client-modules`.
 * @module @origin-ai/cf-client-modules/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-modules'
