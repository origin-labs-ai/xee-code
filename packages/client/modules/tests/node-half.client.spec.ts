...
import { renderIndexInjections, type WebServer, type WebRoute } from '@origin-ai/cf-host-webserver'
...
const RUNTIME_ID = '@origin-ai/cf-client-runtime'
...
describe('HTML bootstrap facade', () => {
  it('precedes blocking preloads and the boot graph, then becomes the live registration target', async () => {
    ...
    const graphAt = html.indexOf('globalThis["__CF_BOOT__"] = ')
