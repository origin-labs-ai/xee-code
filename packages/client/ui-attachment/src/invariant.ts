/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-attachment`.
 * @module @origin-ai/xhe-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-attachment'
