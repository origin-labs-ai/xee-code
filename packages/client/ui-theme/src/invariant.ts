/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-theme`.
 * @module @origin-ai/xhe-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-theme'
