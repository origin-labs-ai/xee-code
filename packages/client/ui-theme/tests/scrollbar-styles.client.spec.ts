...
const INDIRECTION_PREFIX = '--xhe-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--xhe-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--xhe-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--xhe-scrollbar-width)`); a rename in scrollbar.css without
