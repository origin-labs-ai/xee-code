...
3. **Before a PR** — use [cf-pre-push-checks](../../.agents/skills/cf-pre-push-checks/SKILL.md) to select the narrow checks for the outgoing diff; there is no repo-wide pre-push aggregate.
