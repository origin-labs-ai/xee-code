...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@origin-ai/xhe-client-ui-theme/client'
import { apply, inject, LayoutController } from '@origin-ai/xhe-client-ui-layout/client'
import { apply as nodeApply } from '@origin-ai/xhe-client-ui-layout'
import * as invariant from '@origin-ai/xhe-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@origin-ai/xhe-client-ui-layout', expect.any(Function))
