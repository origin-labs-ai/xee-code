/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-layout`.
 * @module @origin-ai/xhe-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-layout'
