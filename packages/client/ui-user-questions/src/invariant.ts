/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-user-questions`.
 * @module @origin-ai/xhe-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-user-questions'
