/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-user-questions`.
 * @module @origin-ai/cf-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-user-questions'
