/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-primitives`.
 * @module @origin-ai/cf-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-primitives'
