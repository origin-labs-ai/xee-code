/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-primitives`.
 * @module @origin-ai/xhe-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-primitives'
