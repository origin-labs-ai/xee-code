...
import type { SessionMaybeProvideInfo, StoredEntry } from '@origin-ai/xhe-client-ui-slots'
import type { SessionProvideInfo, SlotRendererHost } from '@origin-ai/xhe-client-ui-renderer/client'
