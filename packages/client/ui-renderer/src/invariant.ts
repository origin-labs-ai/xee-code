/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-renderer`.
 * @module @origin-ai/cf-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-renderer'
