/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-renderer`.
 * @module @origin-ai/xhe-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-renderer'
