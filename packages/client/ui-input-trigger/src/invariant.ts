/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-input-trigger`.
 * @module @origin-ai/cf-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-input-trigger'
