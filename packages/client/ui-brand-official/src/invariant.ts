/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-brand-official`.
 * @module @origin-ai/cf-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-brand-official'
