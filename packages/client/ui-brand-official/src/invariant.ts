/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-brand-official`.
 * @module @origin-ai/xhe-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-brand-official'
