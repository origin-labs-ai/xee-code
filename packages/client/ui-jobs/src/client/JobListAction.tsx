...
import type { JobView } from '@origin-ai/xhe-client-runtime/client'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@origin-ai/xhe-client-ui-primitives'
