...
import type { JobView } from '@origin-ai/cf-client-runtime/client'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@origin-ai/cf-client-ui-primitives'
