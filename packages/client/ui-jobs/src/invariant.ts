/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-jobs`.
 * @module @origin-ai/xhe-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-jobs'
