/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-jobs`.
 * @module @origin-ai/cf-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-jobs'
