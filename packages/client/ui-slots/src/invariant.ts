/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-slots`.
 * @module @origin-ai/cf-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-slots'
