/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-slots`.
 * @module @origin-ai/xhe-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-slots'
