/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-goal`.
 * @module @origin-ai/xhe-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-goal'
