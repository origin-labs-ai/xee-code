...
import { ConversationEventRegistry } from '@origin-ai/cf-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@origin-ai/cf-goal/client'
