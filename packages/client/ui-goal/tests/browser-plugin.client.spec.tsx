...
import { ConversationEventRegistry } from '@origin-ai/xhe-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@origin-ai/xhe-goal/client'
