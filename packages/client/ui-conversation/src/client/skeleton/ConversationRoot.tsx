...
import type { WorkspaceId } from '@origin-ai/xhe-client-runtime/client'
...
export function ConversationRoot({
  ...
  // Publishes the seat's live height as --xhe-composer-height on the scroll
  ...
  const seatResizeRef = useCallback((seat: HTMLDivElement | null): void => {
    ...
    seatObserver.current = new ResizeObserver(() => {
      scroller.style.setProperty('--xhe-composer-height', `${seat.offsetHeight}px`)
    })
