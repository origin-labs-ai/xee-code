...
import type { ISessions, SessionFace, SessionId } from '@origin-ai/xhe-client-runtime/client'
import type { SubmitImageAttachment, SubmitOutcome } from '@origin-ai/xhe-client-ui-input-trigger/client'
