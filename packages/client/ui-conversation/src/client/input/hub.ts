 ...
 */
import type { ClientContext, ISessions, SessionBinding, SessionFace, SessionId } from '@origin-ai/xhe-client-runtime/client'
import type { InputTriggerController, SubmitImageAttachment, SubmitOutcome } from '@origin-ai/xhe-client-ui-input-trigger/client'
