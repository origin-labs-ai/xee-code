/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-conversation`.
 * @module @origin-ai/cf-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-conversation'
