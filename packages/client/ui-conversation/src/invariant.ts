/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-conversation`.
 * @module @origin-ai/xhe-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-conversation'
