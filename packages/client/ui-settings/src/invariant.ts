/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-settings`.
 * @module @origin-ai/cf-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-settings'
