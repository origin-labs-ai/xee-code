/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-settings-models`.
 * @module @origin-ai/cf-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-settings-models'
