/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-settings-models`.
 * @module @origin-ai/xhe-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-settings-models'
