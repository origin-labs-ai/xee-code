/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-settings-general`.
 * @module @origin-ai/xhe-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-settings-general'
