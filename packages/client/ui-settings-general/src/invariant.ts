/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-settings-general`.
 * @module @origin-ai/cf-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-settings-general'
