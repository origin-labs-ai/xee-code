/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-message-feedback`.
 * @module @origin-ai/xhe-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-message-feedback'
