/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-message-feedback`.
 * @module @origin-ai/cf-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-message-feedback'
