/**
 * Package-owned invariant companion for `@origin-ai/cf-client-locale`.
 * @module @origin-ai/cf-client-locale/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-locale'
