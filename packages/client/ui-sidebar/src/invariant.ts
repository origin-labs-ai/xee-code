/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-sidebar`.
 * @module @origin-ai/cf-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-sidebar'
