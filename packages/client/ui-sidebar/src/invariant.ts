/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-sidebar`.
 * @module @origin-ai/xhe-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-sidebar'
