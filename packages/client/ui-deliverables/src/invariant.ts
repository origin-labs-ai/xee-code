/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-deliverables`.
 * @module @origin-ai/cf-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-deliverables'
