/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-deliverables`.
 * @module @origin-ai/xhe-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-deliverables'
