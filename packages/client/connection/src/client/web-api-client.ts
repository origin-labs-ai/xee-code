...
import { hostFrameSchema, muxFrameSchema } from '@origin-ai/xhe-host-apiproxy/api/events.schema'
import { serverRequestSchema } from '@origin-ai/xhe-host-apiproxy/api/rpc.schema'
