/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-connection`.
 * @module @origin-ai/xhe-client-connection/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-connection'
