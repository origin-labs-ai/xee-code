/**
 * Package-owned invariant companion for `@origin-ai/cf-client-connection`.
 * @module @origin-ai/cf-client-connection/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-connection'
