/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-model-selection`.
 * @module @origin-ai/cf-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-model-selection'
