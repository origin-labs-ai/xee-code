/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-model-selection`.
 * @module @origin-ai/xhe-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-model-selection'
