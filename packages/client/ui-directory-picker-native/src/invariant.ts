/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-directory-picker-native`.
 * @module @origin-ai/xhe-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-directory-picker-native'
