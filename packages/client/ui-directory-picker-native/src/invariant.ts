/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-directory-picker-native`.
 * @module @origin-ai/cf-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-directory-picker-native'
