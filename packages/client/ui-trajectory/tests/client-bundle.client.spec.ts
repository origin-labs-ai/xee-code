 ...
 * not built (`pnpm --filter @origin-ai/xhe-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@origin-ai/xhe-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@origin-ai/xhe-client-runtime/client', await import('@origin-ai/xhe-client-runtime/client')],
      ['@origin-ai/xhe-client-ui-primitives', await import('@origin-ai/xhe-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@origin-ai/xhe-client-locale/client')
