/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-trajectory`.
 * @module @origin-ai/xhe-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-trajectory'
