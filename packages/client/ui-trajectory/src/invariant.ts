/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-trajectory`.
 * @module @origin-ai/cf-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-trajectory'
