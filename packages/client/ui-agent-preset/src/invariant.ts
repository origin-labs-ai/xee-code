/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-agent-preset`.
 * @module @origin-ai/xhe-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-agent-preset'
