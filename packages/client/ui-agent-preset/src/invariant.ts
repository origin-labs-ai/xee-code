/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-agent-preset`.
 * @module @origin-ai/cf-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-agent-preset'
