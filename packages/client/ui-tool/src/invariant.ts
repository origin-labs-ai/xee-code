/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-tool`.
 * @module @origin-ai/cf-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-tool'
