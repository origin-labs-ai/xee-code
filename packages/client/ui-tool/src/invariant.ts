/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-tool`.
 * @module @origin-ai/xhe-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-tool'
