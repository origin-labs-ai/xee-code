/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-skill`.
 * @module @origin-ai/xhe-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-skill'
