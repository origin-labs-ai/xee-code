/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-skill`.
 * @module @origin-ai/cf-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-skill'
