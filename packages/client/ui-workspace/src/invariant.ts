/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-workspace`.
 * @module @origin-ai/cf-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-workspace'
