/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-workspace`.
 * @module @origin-ai/xhe-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-workspace'
