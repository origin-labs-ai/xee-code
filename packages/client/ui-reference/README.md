# `@origin-ai/cf-client-ui-reference`
...
Indirectly, through `@origin-ai/cf-file-reference-local` for path guidance and `@origin-ai/cf-session-reference` for prepared session snapshots.
