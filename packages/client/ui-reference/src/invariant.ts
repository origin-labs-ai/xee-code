/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-reference`.
 * @module @origin-ai/xhe-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-reference'
