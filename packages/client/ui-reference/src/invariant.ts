/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-reference`.
 * @module @origin-ai/cf-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-reference'
