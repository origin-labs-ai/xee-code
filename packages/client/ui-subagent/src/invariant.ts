/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-subagent`.
 * @module @origin-ai/cf-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-subagent'
