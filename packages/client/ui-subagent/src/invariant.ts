/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-subagent`.
 * @module @origin-ai/xhe-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-subagent'
