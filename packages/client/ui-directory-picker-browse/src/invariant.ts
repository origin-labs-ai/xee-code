/**
 * Package-owned invariant companion for `@origin-ai/xhe-client-ui-directory-picker-browse`.
 * @module @origin-ai/xhe-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-client-ui-directory-picker-browse'
