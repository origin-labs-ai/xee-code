/**
 * Package-owned invariant companion for `@origin-ai/cf-client-ui-directory-picker-browse`.
 * @module @origin-ai/cf-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-client-ui-directory-picker-browse'
