...
// (`/types`, zero imports), never the package root: the root's xhe-agent →
// xhe-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@origin-ai/xhe-session-projection/types'
