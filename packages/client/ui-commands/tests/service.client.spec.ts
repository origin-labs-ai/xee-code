...
import { createScope, scopeOf } from '@origin-ai/xhe-client-runtime/client'
import type { SessionId } from '@origin-ai/xhe-client-runtime/client'
import type { ClientSessionContext, ConsumeTokenRequest, InputTriggerPick, InputTriggerSource, SubmitImageAttachment } from '@origin-ai/xhe-client-ui-input-trigger/client'
