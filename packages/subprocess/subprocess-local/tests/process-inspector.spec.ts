...
import type { ProcessInspectorInternals } from '@origin-ai/xhe-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@origin-ai/xhe-subprocess-local/src/windows-inspector.ts'
