...
import { scrubbedParentEnv, SubprocessRuntime } from '@origin-ai/xhe-subprocess'
import type {
  SubprocessHandle,
...
describe('SubprocessRuntime seam', () => {
  ...
  it('scrubbedParentEnv drops credential-shaped and XHE_ names (case-insensitively) but keeps PATH', () => {
    process.env.XHE_SCRUB_PROBE = 'stale'
    ...
    try {
      ...
      expect(env.XHE_SCRUB_PROBE).toBeUndefined()
      ...
      delete process.env.XHE_SCRUB_PROBE
