...
/**
 * Establish this process's proof that one XHE_HOME entry and every ancestor
 ...
 * @param root - absolute `XHE_HOME/attachments/v1` root.
...
export async function commitPreparedImageFile(
  ...
  // Establish XHE_HOME itself against the filesystem root once per process.
