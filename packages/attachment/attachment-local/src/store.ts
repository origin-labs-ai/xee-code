...
/**
 * Establish this process's proof that one CF_HOME entry and every ancestor
 ...
 * @param root - absolute `CF_HOME/attachments/v1` root.
...
export async function commitPreparedImageFile(
  ...
  // Establish CF_HOME itself against the filesystem root once per process.
