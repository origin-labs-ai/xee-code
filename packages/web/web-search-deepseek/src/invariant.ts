/**
 * Package-owned invariant companion for `@origin-ai/cf-web-search-deepseek`.
 * @module @origin-ai/cf-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-web-search-deepseek'
