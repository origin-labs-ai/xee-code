/**
 * Package-owned invariant companion for `@origin-ai/xhe-web-search-deepseek`.
 * @module @origin-ai/xhe-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-web-search-deepseek'
