/**
 * Package-owned invariant companion for `@origin-ai/cf-tool-pwsh-persistent`.
 * @module @origin-ai/cf-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-tool-pwsh-persistent'
