/**
 * Package-owned invariant companion for `@origin-ai/xhe-tool-pwsh-persistent`.
 * @module @origin-ai/xhe-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tool-pwsh-persistent'
