/**
 * Package-owned invariant companion for `@origin-ai/cf-tool-bash-persistent`.
 * @module @origin-ai/cf-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-tool-bash-persistent'
