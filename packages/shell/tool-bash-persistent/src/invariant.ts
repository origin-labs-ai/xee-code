/**
 * Package-owned invariant companion for `@origin-ai/xhe-tool-bash-persistent`.
 * @module @origin-ai/xhe-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-tool-bash-persistent'
