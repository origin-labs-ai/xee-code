/**
 * Package-owned invariant companion for `@origin-ai/cf-code-runtime-worker-thread`.
 * @module @origin-ai/cf-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-code-runtime-worker-thread'
