/**
 * Package-owned invariant companion for `@origin-ai/xhe-code-runtime-worker-thread`.
 * @module @origin-ai/xhe-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-code-runtime-worker-thread'
