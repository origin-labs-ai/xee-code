 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in xhe-llm (tool-call
 * correlation), the shared agent/session `SessionId` in xhe-session, and
 * `JobId` in xhe-jobs. Branding is for ids that cross package boundaries and
