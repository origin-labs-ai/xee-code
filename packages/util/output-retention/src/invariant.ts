/**
 * Package-owned invariant companion for `@origin-ai/xhe-output-retention`.
 * @module @origin-ai/xhe-output-retention/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-output-retention'
