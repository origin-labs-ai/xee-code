/**
 * Package-owned invariant companion for `@origin-ai/cf-output-retention`.
 * @module @origin-ai/cf-output-retention/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-output-retention'
