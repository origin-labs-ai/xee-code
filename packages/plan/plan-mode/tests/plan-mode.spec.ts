...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@origin-ai/xhe-tools'
import { Session, SessionId, type UserMessage } from '@origin-ai/xhe-session'
import AgentRegistry, { agentEvents, type Agent } from '@origin-ai/xhe-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@origin-ai/xhe-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `xhe-plan-mode` beside real `SystemPrompt` and
