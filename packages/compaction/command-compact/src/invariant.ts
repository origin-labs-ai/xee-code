/**
 * Package-owned invariant companion for `@origin-ai/cf-command-compact`.
 * @module @origin-ai/cf-command-compact/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-command-compact'
