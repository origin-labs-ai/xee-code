...
import * as invariant from '@origin-ai/xhe-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@origin-ai/xhe-command-compact', expect.any(Function))
    expect(() => {
