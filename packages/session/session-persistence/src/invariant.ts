/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-persistence`.
 * @module @origin-ai/xhe-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-persistence'
