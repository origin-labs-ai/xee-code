/**
 * Package-owned invariant companion for `@origin-ai/cf-session-persistence`.
 * @module @origin-ai/cf-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-persistence'
