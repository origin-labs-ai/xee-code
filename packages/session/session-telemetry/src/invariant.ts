/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-telemetry`.
 * @module @origin-ai/xhe-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-telemetry'
