/**
 * Package-owned invariant companion for `@origin-ai/cf-session-telemetry`.
 * @module @origin-ai/cf-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-telemetry'
