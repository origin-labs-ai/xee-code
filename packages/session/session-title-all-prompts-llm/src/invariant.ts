/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-title-all-prompts-llm`.
 * @module @origin-ai/xhe-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-title-all-prompts-llm'
