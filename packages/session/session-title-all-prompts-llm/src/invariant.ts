/**
 * Package-owned invariant companion for `@origin-ai/cf-session-title-all-prompts-llm`.
 * @module @origin-ai/cf-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-title-all-prompts-llm'
