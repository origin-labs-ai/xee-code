/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-telemetry-otel`.
 * @module @origin-ai/xhe-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-telemetry-otel'
