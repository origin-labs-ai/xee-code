/**
 * Package-owned invariant companion for `@origin-ai/cf-session-telemetry-otel`.
 * @module @origin-ai/cf-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-telemetry-otel'
