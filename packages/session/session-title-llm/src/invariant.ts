/**
 * Package-owned invariant companion for `@origin-ai/cf-session-title-llm`.
 * @module @origin-ai/cf-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-title-llm'
