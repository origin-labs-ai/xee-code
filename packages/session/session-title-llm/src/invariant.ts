/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-title-llm`.
 * @module @origin-ai/xhe-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-title-llm'
