/**
 * Package-owned invariant companion for `@origin-ai/cf-session-projection`.
 * @module @origin-ai/cf-session-projection/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-projection'
