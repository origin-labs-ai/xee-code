/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-projection`.
 * @module @origin-ai/xhe-session-projection/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-projection'
