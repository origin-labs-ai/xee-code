/**
 * Package-owned invariant companion for `@origin-ai/cf-session-checkpoint-policy`.
 * @module @origin-ai/cf-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-checkpoint-policy'
