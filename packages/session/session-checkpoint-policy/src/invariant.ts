/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-checkpoint-policy`.
 * @module @origin-ai/xhe-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-checkpoint-policy'
