/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-title-first-prompt-llm`.
 * @module @origin-ai/xhe-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-title-first-prompt-llm'
