/**
 * Package-owned invariant companion for `@origin-ai/cf-session-title-first-prompt-llm`.
 * @module @origin-ai/cf-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-title-first-prompt-llm'
