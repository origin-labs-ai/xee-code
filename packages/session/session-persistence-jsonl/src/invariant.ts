/**
 * Package-owned invariant companion for `@origin-ai/xhe-session-persistence-jsonl`.
 * @module @origin-ai/xhe-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-session-persistence-jsonl'
