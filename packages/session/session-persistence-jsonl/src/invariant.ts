/**
 * Package-owned invariant companion for `@origin-ai/cf-session-persistence-jsonl`.
 * @module @origin-ai/cf-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-session-persistence-jsonl'
