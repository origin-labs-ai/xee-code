 ...
 * @module @origin-ai/xhe-session-title
 */
...
import { assertNever, deepFreeze, isAgentLoopRequest } from '@origin-ai/xhe-llm'
import type { GenerateOptions } from '@origin-ai/xhe-llm'
import type {
  Session,
  SessionEvent,
