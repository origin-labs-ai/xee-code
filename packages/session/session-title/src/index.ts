 ...
 * @module @origin-ai/cf-session-title
 */
...
import { assertNever, deepFreeze, isAgentLoopRequest } from '@origin-ai/cf-llm'
import type { GenerateOptions } from '@origin-ai/cf-llm'
import type {
  Session,
  SessionEvent,
