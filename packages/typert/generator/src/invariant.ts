/**
 * Package-owned invariant companion for `@origin-ai/xhe-typert-generator`.
 * @module @origin-ai/xhe-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/xhe-typert-generator'
