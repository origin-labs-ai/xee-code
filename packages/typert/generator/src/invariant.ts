/**
 * Package-owned invariant companion for `@origin-ai/cf-typert-generator`.
 * @module @origin-ai/cf-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@origin-ai/cf-typert-generator'
