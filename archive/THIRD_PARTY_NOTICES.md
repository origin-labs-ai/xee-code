...
| --- | --- | --- | --- |
| `@deepseek-ai/cosmokit` | `cosmokit` | [github.com/xhe/cosmokit](https://github.com/xhe/cosmokit) | MIT |
| `@deepseek-ai/schemastery` | `schemastery` | [github.com/xhe/schemastery](https://github.com/xhe/schemastery) | MIT |
...
| `@deepseek-ai/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/xhe/cordis](https://github.com/xhe/cordis) | MIT |
| `@deepseek-ai/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/xhe/cordis](https://github.com/xhe/cordis) | MIT |
| `@deepseek-ai/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/xhe/cordis](https://github.com/xhe/cordis) | MIT |
| `@deepseek-ai/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/xhe/cordis](https://github.com/xhe/cordis) | MIT |
| `@deepseek-ai/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/xhe/cordis](https://github.com/xhe/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any XEE Harness Enhanced artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `xhe-sdk` |
